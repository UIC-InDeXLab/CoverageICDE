...
public class Cli2 {
	...
	public static final String CMD_LEVEL_LONG = "level";
	...
	public static final String CMD_LEVEL_MSG = "specify the level";
	
	public static final String[] commandTypes = new String[]{CMD_ALGORITHM_SHORT,CMD_NUM_RECORDS_SHORT,CMD_NUM_DIMENSIONS_SHORT,CMD_THRESHOLD_SHORT,CMD_LEVEL_SHORT};

	public Cli2(String[] args) {
	...
	public void parse() {
		...
		try {
			...
			if (cmd.hasOption(CMD_LEVEL_SHORT)) {
				log.log(Level.INFO, "Using cli argument -l="
						+ cmd.getOptionValue(CMD_LEVEL_SHORT));
	...
	public Map<String, String> getArguments() {
		...
		if (cmd.hasOption(CMD_LEVEL_SHORT)) {
			commandlineInfo.put(CMD_LEVEL_SHORT,
					cmd.getOptionValue(CMD_LEVEL_SHORT));
		}
